...
def LoopForPrzystanki(fileIn:str,fileOut:str):
    ...
    for e in fileI:
        ...
        if(e!=""):
            ...
            print("string a",title,"=",PrzystankiParsing(href),";", end="\n", sep="")
...
#LinksParsing("https://moovitapp.com/index/pl/transport_publiczny-lines-Krakow-5499-1373691","xz.txt")
#LoopForPrzystanki("xz.txt","x.txt")
